...
class WikiDocument(wikipediaapi.WikipediaPage):
    """ WIP: WikipediaPage wrapper with parse_article() method to produce Elasticsearch-indexable object """
